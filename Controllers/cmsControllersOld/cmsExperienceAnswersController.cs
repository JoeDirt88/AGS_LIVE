...
namespace AGS.ServerAPI.Controllers.cmsControllersOld
{
    public class cmsExperienceAnswersController : Controller
    {
        ...
        {
            var tblExperienceAnswers = db.tblExperienceAnswers.Include(t => t.tblClients).Include(t => t.tblExperienceTypes);
        ...
        {
            ViewBag.iClientID = new SelectList(db.tblClients, "iClientID", "strClientID");
        ...
        public ActionResult Create([Bind(Include = "iExperienceAnswerID,iAddedBy,dtAddedBy,iEditedBy,dtEditedby,iClientID,iExperienceTypeID,strAnswers,iAverage,bIsDeleted")] tblExperienceAnswers tblExperienceAnswers)
        {
            ...
            ViewBag.iClientID = new SelectList(db.tblClients, "iClientID", "strClientID", tblExperienceAnswers.iClientID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "iExperienceAnswerID,iAddedBy,dtAddedBy,iEditedBy,dtEditedby,iClientID,iExperienceTypeID,strAnswers,iAverage,bIsDeleted")] tblExperienceAnswers tblExperienceAnswers)
        {
            if (ModelState.IsValid)
            {
                var user = (clsUsers)Session["clsUser"];
